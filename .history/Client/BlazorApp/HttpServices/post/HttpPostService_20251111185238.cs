...
public class HttpPostService : IPostService
{
    ...
    //NEW: Paging + Sorting
    public async Task<PagedResult<PostDto>> GetPageAsync(int page, int pageSize, string? sort, string? title = null, int? userId = null)
    {
        ...
        return JsonSerializer.Deserialize<PagedResult<PostDto>>(txt, new JsonSerializerOptions
        {
            PropertyNameCaseInsensitive = true
        })!;
    }
