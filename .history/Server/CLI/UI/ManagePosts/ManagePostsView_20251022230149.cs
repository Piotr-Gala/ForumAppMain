    ...
    public async Task ShowAsync()
    {
        while (true)
        {
            ...
            switch (cmd)
            {
                ...
                case "7": await new ListPostsByUserIdView(_posts, _users).ShowAsync(); break;   // was .Show()
                case "8": await new ListCommentsByUserIdView(_comments, _users).ShowAsync(); break; // was .Show()
                case "b": return;
